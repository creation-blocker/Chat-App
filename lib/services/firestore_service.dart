import 'package:chat_tutorial/models/chat_model.dart';
import 'package:chat_tutorial/models/friend_request_model.dart';
import 'package:chat_tutorial/models/friendship_model.dart';
import 'package:chat_tutorial/models/message_model.dart';
import 'package:chat_tutorial/models/notification_model.dart';
...
class FirestoreService {
  ...
  Future<void> responseToFriendRequest(
    String requestId,
    ...
    try {
        ...
        if (status == FriendRequestStatus.accepted) {
          ...
          await createNotification(
            NotificationModel(
              ...
              body: 'You friend request has been accepted',
          ...
          await createNotification(
            NotificationModel(
              ...
              body: 'You friend request has been declinde',
      ...
      throw Exception('Failed To Response To Friend Request: ${e.toString()}');
    }
  }
  ...
  Stream<List<FriendshipModel>> getFriendsStrem(String userId) {
    return _firestore
        .collection('friendships')
  ...
  Future<void> updateUnreadCount(
    ...
    try {
      ...
      throw Exception('Failed to upadte unread count: ${e.toString()}');
    }
  }
  ...
  Stream<List<MessageModel>> getMessageStream(String userId1, String userId2){
    return _firestore.collection('messages').where(
  ...
  Future<void> markMessageAsRead(String messageId) async {
    try {
      ...
      throw Exception('Failde to mark message as read: ${e.toString()}');
    }
  }
  ...
  Future<void> deleteMessage(String messageId) async {
    try {
      ...
      throw Exception('Failde to delete message: ${e.toString()}');
    }
  }
  ...
  Future<void> editMessage(String messageId, String newContent) async {
    try {
      ...
      throw Exception('Failde to edit message: ${e.toString()}');
    }
  }
  ...
  Future<void> createNotification(NotificationModel notification) async {
    try {
      ...
      throw Exception('Failde to create notification: ${e.toString()}');
    }
  }
  ...
  Future<void> markNotificationAsRead(String notificationId) async {
    try {
      ...
      throw Exception('Failde to mark notification as read: ${e.toString()}');
    }
  }
  ...
  Future<void> markAllNotificationsAsRead(String userId) async {
    try {
      ...
      throw Exception('Failde to mark all notification as read: ${e.toString()}');
    }
  }
  ...
  Future<void> deleteNotification(String notificationId) async {
    try {
      ...
      throw Exception('Failde to delete notification: ${e.toString()}');
    }
  }
